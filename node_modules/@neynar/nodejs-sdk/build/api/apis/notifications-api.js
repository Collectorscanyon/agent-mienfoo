...
const NotificationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchAllNotifications: async (fid, type, priorityMode, cursor, options = {}) => {
         ...
         *
         */
        fetchChannelNotificationsForUser: async (fid, channelIds, priorityMode, cursor, options = {}) => {
            // verify required parameter 'fid' is not null or undefined
         ...
         *
         */
        fetchNotificationsByParentUrlForUser: async (fid, parentUrls, priorityMode, cursor, options = {}) => {
            // verify required parameter 'fid' is not null or undefined
         ...
         *
         */
        markNotificationsAsSeen: async (markNotificationsAsSeenReqBody, options = {}) => {
...
const NotificationsApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchAllNotifications(fid, type, priorityMode, cursor, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchChannelNotificationsForUser(fid, channelIds, priorityMode, cursor, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchNotificationsByParentUrlForUser(fid, parentUrls, priorityMode, cursor, options) {
            var _a, _b, _c;
         ...
         *
         */
        async markNotificationsAsSeen(markNotificationsAsSeenReqBody, options) {
            var _a, _b, _c;
...
class NotificationsApi extends base_1.BaseAPI {
     ...
     */
    fetchAllNotifications(requestParameters, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).fetchAllNotifications(requestParameters.fid, requestParameters.type, requestParameters.priorityMode, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of notifications for a user in specific channels
     * @summary For user by channel
     ...
     */
    fetchChannelNotificationsForUser(requestParameters, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).fetchChannelNotificationsForUser(requestParameters.fid, requestParameters.channelIds, requestParameters.priorityMode, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of notifications for a user in specific parent_urls
     * @summary For user by parent_urls
     ...
     */
    fetchNotificationsByParentUrlForUser(requestParameters, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).fetchNotificationsByParentUrlForUser(requestParameters.fid, requestParameters.parentUrls, requestParameters.priorityMode, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Mark notifications as seen
     * @summary Mark as seen
     ...
     */
    markNotificationsAsSeen(requestParameters, options) {
        return (0, exports.NotificationsApiFp)(this.configuration).markNotificationsAsSeen(requestParameters.markNotificationsAsSeenReqBody, options).then((request) => request(this.axios, this.basePath));
    }
}
