...
const CastApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchBulkCasts: async (casts, viewerFid, sortType, options = {}) => {
         ...
         *
         */
        lookupCastByHashOrWarpcastUrl: async (identifier, type, viewerFid, options = {}) => {
         ...
         *
         */
        lookupCastConversation: async (identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, sortType, fold, limit, cursor, options = {}) => {
            // verify required parameter 'identifier' is not null or undefined
         ...
         *
         */
        searchCasts: async (q, authorFid, viewerFid, parentUrl, channelId, priorityMode, limit, cursor, options = {}) => {
...
const CastApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchBulkCasts(casts, viewerFid, sortType, options) {
            var _a, _b, _c;
         ...
         *
         */
        async lookupCastByHashOrWarpcastUrl(identifier, type, viewerFid, options) {
            var _a, _b, _c;
         ...
         *
         */
        async lookupCastConversation(identifier, type, replyDepth, includeChronologicalParentCasts, viewerFid, sortType, fold, limit, cursor, options) {
            var _a, _b, _c;
         ...
         *
         */
        async searchCasts(q, authorFid, viewerFid, parentUrl, channelId, priorityMode, limit, cursor, options) {
            var _a, _b, _c;
...
class CastApi extends base_1.BaseAPI {
     ...
     */
    fetchBulkCasts(requestParameters, options) {
        return (0, exports.CastApiFp)(this.configuration).fetchBulkCasts(requestParameters.casts, requestParameters.viewerFid, requestParameters.sortType, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetches all composer actions on Warpcast. You can filter by top or featured.
     * @summary Fetch composer actions
     ...
     */
    lookupCastByHashOrWarpcastUrl(requestParameters, options) {
        return (0, exports.CastApiFp)(this.configuration).lookupCastByHashOrWarpcastUrl(requestParameters.identifier, requestParameters.type, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Gets all casts related to a conversation surrounding a cast by passing in a cast hash or Warpcast URL. Includes all the ancestors of a cast up to the root parent in a chronological order. Includes all direct_replies to the cast up to the reply_depth specified in the query parameter.
     * @summary Conversation for a cast
     ...
     */
    searchCasts(requestParameters, options) {
        return (0, exports.CastApiFp)(this.configuration).searchCasts(requestParameters.q, requestParameters.authorFid, requestParameters.viewerFid, requestParameters.parentUrl, requestParameters.channelId, requestParameters.priorityMode, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
}
