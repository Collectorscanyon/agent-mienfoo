...
export declare const MuteApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchMuteList: (fid: number, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const MuteApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchMuteList(fid: number, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MuteListResponse>>;
    /**
     * Adds a mute for a given FID. This is an allowlisted API, reach out if you want access.
     * @summary Mute FID
     * @param {MuteReqBody} muteReqBody
