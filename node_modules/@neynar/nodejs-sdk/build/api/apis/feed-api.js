...
const FeedApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchCastsForUser: async (fid, viewerFid, limit, cursor, includeReplies, parentUrl, channelId, options = {}) => {
         ...
         *
         */
        fetchFeed: async (feedType, filterType, fid, fids, parentUrl, channelId, membersOnly, embedUrl, embedTypes, withRecasts, limit, cursor, viewerFid, options = {}) => {
         ...
         *
         */
        fetchFeedByChannelIds: async (channelIds, withRecasts, viewerFid, withReplies, membersOnly, limit, cursor, shouldModerate, options = {}) => {
         ...
         *
         */
        fetchFeedByParentUrls: async (parentUrls, withRecasts, viewerFid, withReplies, limit, cursor, options = {}) => {
         ...
         *
         */
        fetchFeedForYou: async (fid, viewerFid, provider, limit, cursor, providerMetadata, options = {}) => {
            // verify required parameter 'fid' is not null or undefined
         ...
         *
         */
        fetchFramesOnlyFeed: async (limit, viewerFid, cursor, options = {}) => {
         ...
         *
         */
        fetchTrendingFeed: async (limit, cursor, viewerFid, timeWindow, channelId, provider, providerMetadata, options = {}) => {
         ...
         *
         */
        fetchUserFollowingFeed: async (fid, viewerFid, withRecasts, limit, cursor, options = {}) => {
            // verify required parameter 'fid' is not null or undefined
...
const FeedApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchCastsForUser(fid, viewerFid, limit, cursor, includeReplies, parentUrl, channelId, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchFeed(feedType, filterType, fid, fids, parentUrl, channelId, membersOnly, embedUrl, embedTypes, withRecasts, limit, cursor, viewerFid, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchFeedByChannelIds(channelIds, withRecasts, viewerFid, withReplies, membersOnly, limit, cursor, shouldModerate, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchFeedByParentUrls(parentUrls, withRecasts, viewerFid, withReplies, limit, cursor, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchFeedForYou(fid, viewerFid, provider, limit, cursor, providerMetadata, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchFramesOnlyFeed(limit, viewerFid, cursor, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchTrendingFeed(limit, cursor, viewerFid, timeWindow, channelId, provider, providerMetadata, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchUserFollowingFeed(fid, viewerFid, withRecasts, limit, cursor, options) {
            var _a, _b, _c;
...
class FeedApi extends base_1.BaseAPI {
     ...
     */
    fetchCastsForUser(requestParameters, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchCastsForUser(requestParameters.fid, requestParameters.viewerFid, requestParameters.limit, requestParameters.cursor, requestParameters.includeReplies, requestParameters.parentUrl, requestParameters.channelId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch casts based on filters. Ensure setting the correct parameters based on the feed_type and filter_type.
     * @summary By filters
     ...
     */
    fetchFeedByChannelIds(requestParameters, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchFeedByChannelIds(requestParameters.channelIds, requestParameters.withRecasts, requestParameters.viewerFid, requestParameters.withReplies, requestParameters.membersOnly, requestParameters.limit, requestParameters.cursor, requestParameters.shouldModerate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch feed based on parent URLs
     * @summary By parent URLs
     ...
     */
    fetchFeedByParentUrls(requestParameters, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchFeedByParentUrls(requestParameters.parentUrls, requestParameters.withRecasts, requestParameters.viewerFid, requestParameters.withReplies, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch a personalized For You feed for a user
     * @summary For you
     ...
     */
    fetchFeedForYou(requestParameters, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchFeedForYou(requestParameters.fid, requestParameters.viewerFid, requestParameters.provider, requestParameters.limit, requestParameters.cursor, requestParameters.providerMetadata, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch feed of casts with Frames, reverse chronological order
     * @summary Casts with Frames
     ...
     */
    fetchFramesOnlyFeed(requestParameters = {}, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchFramesOnlyFeed(requestParameters.limit, requestParameters.viewerFid, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch 10 most popular casts for a given user FID; popularity based on replies, likes and recasts; sorted by most popular first
     * @summary 10 most popular casts
     ...
     */
    fetchUserFollowingFeed(requestParameters, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchUserFollowingFeed(requestParameters.fid, requestParameters.viewerFid, requestParameters.withRecasts, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
}
