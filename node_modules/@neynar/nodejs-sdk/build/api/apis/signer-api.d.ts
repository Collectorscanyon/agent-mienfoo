...
export declare const SignerApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchAuthorizationUrl: (clientId: string, responseType: AuthorizationUrlResponseType, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const SignerApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchAuthorizationUrl(clientId: string, responseType: AuthorizationUrlResponseType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthorizationUrlResponse>>;
    /**
     * Fetches the status of a developer managed signer by public key
     * @summary Status by public key
     * @param {string} publicKey
